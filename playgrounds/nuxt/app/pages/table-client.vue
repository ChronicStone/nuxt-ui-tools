...
import { defineTableSchema, useTable, type GenericObject } from '../../../../packages/table/src'
    ...
    <div :class="classes.panel">
      ...
      <div :class="classes.panelCopy">
        ...
        <p :class="classes.panelText">
          This route runs in client mode, so option filter counts are derived automatically from the full local dataset without extra filter configuration.
        </p>
      </div>
