...
import { cascaderFieldKind } from './cascader/config'
...
import { dateRangeFieldKind } from './date-range/config'
import { dateTimeRangeFieldKind } from './date-time-range/config'
import { dateTimeFieldKind } from './date-time/config'
import { dateFieldKind } from './date/config'
import { dividerFieldKind } from './divider/config'
import { fileFieldKind } from './file/config'
import { groupFieldKind } from './group/config'
...
import { matrixFieldKind } from './matrix/config'
import { monthRangeFieldKind } from './month-range/config'
import { monthFieldKind } from './month/config'
...
import { treeSelectFieldKind } from './tree-select/config'
