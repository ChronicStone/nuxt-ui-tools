        ...
        tabs: [
          {
            fields: [
              ...
              { key: 'code', label: 'Code interne', mono: true, type: 'text' },
...
export function productLineFormSchema() {
  return defineFormSchema({
    ...
    fields: [
      ...
      { help: 'Utilisé dans les exports', key: 'code', label: 'Code', mono: true, type: 'text' },
    ],
  ...
  return defineFormSchema({
    ...
    fields: [
      ...
      { key: 'documentSection', label: 'Document', type: 'section' },
      {
        ...
        dropzoneLabel: 'Déposer le PDF ou parcourir',
        key: 'pdf',
